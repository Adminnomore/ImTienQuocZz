...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>thì Beta Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hãy sử dụng Fluxus để có trải nghiệm tốt!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Tham gia tele để cập nhật thông tin mới nhất nhé<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Admin : TQuocZz <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Beta Hub", HidePremium = false, IntroText = "NightHub Library", SaveConfig = true, ConfigFolder = "Night Hub"})

OrionLib:MakeNotification({
	Name = "Beta Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://16161921825",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "Beta Hub",
	Content = "Beta Hub Not Skidder, Please don't says",
	Image = "rbxassetid://16161921825",
	Time = 25
})
...
W:AddLabel("[+] I Will overcome Hirimii, Beta Hub!!!")
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : dễ đá nên đéo làm(sắp có)")
